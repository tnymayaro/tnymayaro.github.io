...
Data: originally from the [Gapminder Foundation](https://www.gapminder.org/data/)
(CC-BY licensed material, per Gapminder's own [citation terms](https://www.gapminder.org/free-material/)),
accessed here via the [plotly.express built-in dataset](https://plotly.com/python-api-reference/generated/plotly.express.data.html#plotly.express.data.gapminder),
a curated excerpt released under CC0 by its maintainers.
